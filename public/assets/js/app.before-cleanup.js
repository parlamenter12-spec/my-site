...
async function loadPage(path) {
    try {
        ...
        return `<div class="alert alert-danger">Ошибка загрузки страницы</div>`;
    }
}
        ...
        async function renderPage(slug) {
            ...
            if (!slug || slug === 'home') {
                ...
                `;
                contentDiv.innerHTML = await loadPage("/pages/home.html");
                // Заполняем услуги
        ...
        async function init() {
            await loadComponent("heroComponent", "/components/hero.html");
